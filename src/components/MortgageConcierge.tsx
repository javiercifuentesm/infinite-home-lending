...
function MortgageConciergeInner({ assetCapture = false }: { assetCapture?: boolean }) {
  ...
  const GREETINGS = lang === "es"
    ? [
        ...
        "¡Hola! Soy Sarah de Infinite Home Lending, atendiendo Maryland, D.C. y Virginia. Ayudo a compradores y propietarios a encontrar la solución correcta — ya sea un préstamo de compra, una refinanciación, un HELOC o una hipoteca inversa. ¿Qué le gustaría explorar hoy?",
      ]
    : [
