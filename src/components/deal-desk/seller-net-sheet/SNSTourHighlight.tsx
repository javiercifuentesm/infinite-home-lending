...
export function SNSTourHighlight({ targetId, active }: Props) {
  ...
  return (
    <div
      aria-hidden
      className="ihl-tour-highlight ihl-tour-pulse print:hidden pointer-events-none fixed z-[9997] rounded-[10px] border-[2.5px] border-[#C6A15B] max-sm:border-2"
      style={{
        top: box.top,
        left: box.left,
        width: box.width,
