...
export function BuyVsRentCTA() {
  return (
    <div className="flex flex-col gap-6 rounded-xl border border-[var(--color-border-tertiary)] bg-white p-6 sm:flex-row sm:items-center sm:justify-between sm:gap-8 sm:p-8">
      <div>
        <p className="text-[13px] font-medium text-[#0B2A4A]">Want to run this for your actual situation?</p>
        <p className="mt-1 text-[11px] text-[var(--color-text-tertiary)]">
          We&apos;ll model the numbers specific to your finances and the MD-DC-VA market.
        </p>
      </div>
      <Link
        to="/contact"
