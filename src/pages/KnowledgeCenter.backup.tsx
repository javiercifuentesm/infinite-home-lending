...
export default function KnowledgeCenter() {
  ...
  return (
    <PageContainer className="min-h-screen bg-[#fafbfc] pb-0">
      ...
      <section
        id="guided-entry"
        className={`relative border-b border-slate-200/60 overflow-hidden pt-10 lg:pt-12 pb-12 lg:pb-16 bg-gradient-to-b from-white via-white to-surface/50 scroll-mt-36`}
      >
      ...
      <section className="border-b border-slate-200/60 bg-surface/40 py-10 lg:py-14">
      ...
      {/* —— CTA —— */}
      <section className="py-10 lg:py-14 bg-gradient-to-b from-white to-surface/30">
      ...
      <section className="border-t border-slate-200/70 bg-gradient-to-b from-navy to-[#071018] text-white">
        <div className={PAGE_CONTENT_RAIL_CLASS}>
          <div className="max-w-3xl mx-auto py-10 lg:py-12 text-center">
