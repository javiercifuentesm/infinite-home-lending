import type { FounderEditorialPostV2Props } from "../../types";

export const FOUNDER_EDITORIAL_POST_V2_DEFAULTS: Required<
  Omit<FounderEditorialPostV2Props, "className">
> = {
  seriesLabel: "Founder Letter",
  editionLabel: "2026",
